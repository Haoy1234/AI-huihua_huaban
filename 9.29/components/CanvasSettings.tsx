...
import type { WheelAction, Hotkey } from '../types';
            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between p-2 bg-black/20 rounded-md">
                        <span className="text-sm font-mono">{formatHotkey(generateHotkey)}</span>
                        <button 
                            onClick={handleSetHotkey}
                            className="px-3 py-1 text-xs rounded bg-white/10 hover:bg-white/20"
                        >
                            {isRecording ? t('settings.pressKey') : t('settings.setHotkey')}
                        </button>
                    </div>
                </div>
