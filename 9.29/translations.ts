...
export const translations = {
  en: {
    ...
    promptBar: {
        ...
        aspectRatioLandscapeW: 'Landscape (16:9)',
        aspectRatioPortraitT: 'Portrait (9:16)',
    ...
    contextMenu: {
        ...
        fontSize: 'Font Size',
        delete: 'Delete',
        autoCombine: 'Auto-Combine with AI',
    ...
    sidePanel: {
        ...
        noFrames: 'No frames yet. Use the Frame tool to create slides for a presentation.',
    },
    presentation: {
  ...
  zho: {
    ...
    promptBar: {
        placeholderDefault: '描述您想从零开始生成的图片...',
        placeholderDefaultVideo: '描述您想从零开始生成的视频...',
        placeholderSingle: '描述您想做的更改或选择一个快速效果...',
        placeholderMultiple: (count: number) => `已选择 ${count} 个元素作为上下文。描述结果或选择一个效果...`,
        generate: '生成',
        imageMode: '图片',
        videoMode: '视频',
        ...
        aspectRatioLandscapeW: '横向 (16:9)',
        aspectRatioPortraitT: '纵向 (9:16)',
        aspectRatioLandscape: '横向 (4:3)',
        aspectRatioPortrait: '纵向 (3:4)',
    },
    quickPromptsAriaLabel: '选择一个快速效果',
    ...
    sidePanel: {
        ...
        present: '演示',
        deleteFrame: '删除画框',
        noFrames: '暂无画框。使用画框工具创建演示文稿的幻灯片。',
    },
    presentation: {
        exit: '退出演示',
        smooth: '平滑',
