...
interface CanvasSettingsProps {
    ...
    t: (key: string) => string;
    uiLayout?: 'classic' | 'v2';
    setUiLayout?: (layout: 'classic' | 'v2') => void;
}
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 p-1 bg-black/20 rounded-md">
                        <button 
                            ...
                            className={`flex-1 py-1.5 text-sm rounded ${uiLayout === 'classic' ? 'bg-blue-500 text-white' : 'hover:bg-white/10'}`}
                        >
                            Classic
                        </button>
                        <button 
                            onClick={() => setUiLayout('v2')}
                            className={`flex-1 py-1.5 text-sm rounded ${uiLayout === 'v2' ? 'bg-blue-500 text-white' : 'hover:bg-white/10'}`}
                        >
                            V2
                        </button>
                    </div>
